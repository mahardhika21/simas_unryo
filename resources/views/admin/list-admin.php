...
<div class="pcoded-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="card-block ">
                                                            ...
                                                            <h5>List Admin</h5>
                                                             <button class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#add-data-admin"><i class="fa fa-plus-circle" ></i>Tambah Data Admin</button>
                                                            </div>
    ...
    <div class="modal fade" id="add-data-admin" tabindex="-1" role="dialog">
    ...
    <script type="text/javascript">
      $(function(){
            ...
            $('#table-admin').on('click', '[id=btnDelete]', function(){
